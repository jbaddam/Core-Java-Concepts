...
public class AbstractClassImplementation {
	...
	public static void main(String[] args) {
		...
		//Creating object  for HumanBeing class using Mammal abstract grand parent class reference and calling the available methods
				Mammal mHumanbeing = new HumanBeing();
				mHumanbeing.eat();
				 
				//Creating object for HumanBeing class using LandMammal abstract  parent class reference and calling the available methods
				...
				System.out.println("\nHumanBeing execution completed\n\n");
								...
								//Creating object  for Whale class using Mammal abstract grand parent class reference and calling the available methods
								Mammal mwhale = new Whale();
								mwhale.eat();
								 
								//Creating object for Whale class using WaterMammal abstract  parent class reference and calling the available methods
